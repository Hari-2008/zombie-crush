...
function preload(){
  ...
  zombiecry = loadImage("./assets/zombie.png");
...
function setup() {
  ...
  bridge = new Bridge(22, { x: 50, y: height / 2 - 100 });
  jointPoint = new Base(width - 250, height / 2 - 80, 40, 20);
  ...
  zombie.addAnimation("zombie.png",zombiecry)
...
function draw() {
  ...
  for(var stone of stones){
    ...
    if(distance<= 20){
      ...
      zombie.changeAnimation("zombie.png");
      collided = true;
